...
class SLIT {
  ...
  /*
   * given a matrix and a slit window, return T - R where: + the slit window is a
   * sub-matrix of the input matrix defined by: - the row index r of its top-left
   * corner - the column index c of its top-left corner - its width (i.e., number
   * of columns) - a height of 2 rows (always) + T is the number of occurrences of
   * 'T' in the slit window + R is the number of occurrences of the rest of the
   * bases (i.e., 'A', 'C', and 'G') in the slit window
   * 
   * For example, if the input matrix is:
   * 
   * TTTACTCT and r = 5 then T = 1 and the method returns -7 CTTTTTGG c = 3 R = 7
   * AGTTATCT w = 4 TAATTTTT TTTCCTCT GTTCAGTA TTTCACGG TGCTTTTT
   */
